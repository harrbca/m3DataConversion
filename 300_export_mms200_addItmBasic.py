...
def main():
    ...
    template_helper = TemplateHelper("API_MMS200MI_AddItmBasic.xlsx")
    query_path = config.get('QUERIES', 'mms200_addItmBasic_sql_query_path')
    transformer = config.get("TRANSFORMER", "mms200_transformer")
    ...
    transformer = load_transformer("mms200", transformer)
    ...
    template_helper.save('mms200_addItmBasic_output_path')
